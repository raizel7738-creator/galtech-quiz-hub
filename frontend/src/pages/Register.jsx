...
import { Eye, EyeOff, UserPlus, User, Lock, Mail, ArrowLeft, Sparkles, Shield } from 'lucide-react';
      ...
      <div className="modern-auth-container">
        <div className="modern-auth-card register-card">
          <div className="auth-card-header">
            ...
            <h1 className="auth-main-title">Join GALTech!</h1>
            <p className="auth-main-subtitle">
              Create your account and start your learning journey with interactive quizzes
            </p>
          </div>
            ...
            <div className="input-group">
              ...
              <div className="input-wrapper">
                ...
                >
                  ...
                  <option value="admin">Admin - Manage quizzes and users</option>
                </select>
              </div>
            </div>
